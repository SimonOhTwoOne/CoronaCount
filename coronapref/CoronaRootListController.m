...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(id)arg2 specifier:(id)arg3 {
	self = [super initWithStyle:style reuseIdentifier:arg2 specifier:arg3];
	if (self) {
